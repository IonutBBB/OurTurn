...
import { getCreativePromptKeys } from '../../src/utils/activity-templates';
...
export default function ActivityCreateScreen() {
  ...
  const promptKeys = getCreativePromptKeys();
  ...
  useEffect(() => {
    const check = async () => {
      const done = await AsyncStorage.getItem(`activity_completed_create_${today}`);
      if (done === 'true') setResponseMode('done');
    };
    check();
  }, [today]);

  const markComplete = async () => {
    await AsyncStorage.setItem(`activity_completed_create_${today}`, 'true');
        ...
        <View style={styles.content}>
          <View style={styles.followUpCard}>
            ...
            <Text style={styles.followUpText}>
              {t('patientApp.activities.create.followUp')}
            </Text>
      ...
      <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>{t('patientApp.activities.create.title')}</Text>
          </View>
