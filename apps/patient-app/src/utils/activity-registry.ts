...
export const ACTIVITY_REGISTRY: ActivityDefinition[] = [
  ...
  },
  {
    ...
    domain: 'executive',
    emoji: '📦',
    titleKey: 'patientApp.stim.sortingCategorizing.title',
    descriptionKey: 'patientApp.stim.sortingCategorizing.description',
  ...
  },
  {
    ...
    domain: 'sound',
    emoji: '🔊',
    titleKey: 'patientApp.stim.soundIdentification.title',
    descriptionKey: 'patientApp.stim.soundIdentification.description',
  ...
  },
  {
    ...
    domain: 'creative',
    emoji: '🖼️',
    titleKey: 'patientApp.stim.artDiscussion.title',
    descriptionKey: 'patientApp.stim.artDiscussion.description',
