    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#121212]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. User Accounts</h2>
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">4.1 Registration</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              You must provide accurate and complete information when creating an account.
              You are responsible for maintaining the security of your account credentials.
            </p>

            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">4.2 Care Codes</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">4.3 Account Responsibility</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">5. Acceptable Use</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">6. User Content</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">7. Subscriptions and Payments</h2>
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">7.1 Free and Paid Tiers</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">7.2 Billing</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Paid subscriptions are billed in advance on a monthly or annual basis.
              Subscription fees are non-refundable except as required by law.
            </p>

            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">7.3 Cancellation</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              You may cancel your subscription at any time. Access to paid features continues
              until the end of your current billing period.
            </p>

            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">7.4 Price Changes</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">8. Location Features</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">9. AI Features</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">10. Intellectual Property</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">11. Limitation of Liability</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">12. Indemnification</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">13. Termination</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">14. Changes to Terms</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">15. Governing Law</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">16. Contact</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
