...
export const metadata: Metadata = {
  ...
  title: {
    default: 'OurTurn Care — Daily Care for Families Living with Dementia',
    template: '%s | OurTurn Care',
  },
  description:
    'OurTurn Care helps families organize daily routines, coordinate care, and stay connected — a calm app for your loved one, a powerful hub for you.',
  keywords: [
    'family caregiver',
    'daily care plan',
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    siteName: 'OurTurn Care',
    title: 'OurTurn Care — Daily Care for Families Living with Dementia',
    description:
    ...
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'OurTurn Care — Daily care for families' }],
  },
  twitter: {
