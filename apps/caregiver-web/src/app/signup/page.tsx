  ...
  return (
    <div className="min-h-screen bg-surface-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        ...
        {/* Signup card */}
        <main className="card-paper p-8" role="main" aria-label="Signup form">
          {/* OAuth */}
          <div className="space-y-2.5 mb-6" role="group" aria-label="Sign up with social providers">
            <button
              type="button"
          ...
          {/* Email form */}
          <form onSubmit={handleEmailSignup} className="space-y-4" aria-label="Sign up with email">
            {error && (
