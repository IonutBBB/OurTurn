...
export const WHO_ISUPPORT_ARTICLE: ArticleDefinition = {
  slug: 'who-isupport-complete-guide',
  emoji: '📘',
  titleKey: 'articles.whoIsupportCompleteGuide.title',
  summaryKey: 'articles.whoIsupportCompleteGuide.summary',
  contentKey: 'articles.whoIsupportCompleteGuide.content',
  category: 'self_care',
...
export const ARTICLES: ArticleDefinition[] = [
  ...
  {
    slug: 'caregiving-journey',
    emoji: '🛤️',
    titleKey: 'articles.caregivingJourney.title',
    summaryKey: 'articles.caregivingJourney.summary',
    contentKey: 'articles.caregivingJourney.content',
    category: 'self_care',
    readingTimeMinutes: 4,
    order: 15,
  },
  {
    ...
    emoji: '🧘',
    titleKey: 'articles.relaxationExercises.title',
    summaryKey: 'articles.relaxationExercises.summary',
    contentKey: 'articles.relaxationExercises.content',
    category: 'self_care',
    readingTimeMinutes: 4,
    order: 16,
  },
  {
    ...
    emoji: '🌸',
    titleKey: 'articles.pleasantActivities.title',
    summaryKey: 'articles.pleasantActivities.summary',
    contentKey: 'articles.pleasantActivities.content',
    category: 'self_care',
    readingTimeMinutes: 3,
    order: 17,
  },
  {
    ...
    emoji: '💡',
    titleKey: 'articles.cognitiveReframing.title',
    summaryKey: 'articles.cognitiveReframing.summary',
    contentKey: 'articles.cognitiveReframing.content',
    category: 'self_care',
    readingTimeMinutes: 3,
    order: 18,
  },
  {
    slug: 'supported-decisions',
    emoji: '🤝',
    titleKey: 'articles.supportedDecisions.title',
    summaryKey: 'articles.supportedDecisions.summary',
    contentKey: 'articles.supportedDecisions.content',
    category: 'communication',
    readingTimeMinutes: 3,
    order: 19,
  },
  {
    slug: 'behaviour-change-cycle',
    emoji: '🔁',
    titleKey: 'articles.behaviourChangeCycle.title',
    summaryKey: 'articles.behaviourChangeCycle.summary',
    contentKey: 'articles.behaviourChangeCycle.content',
    category: 'behaviors',
    readingTimeMinutes: 3,
    order: 20,
  },
  {
    slug: 'memory-loss-strategies',
    emoji: '🧩',
    titleKey: 'articles.memoryLossStrategies.title',
    summaryKey: 'articles.memoryLossStrategies.summary',
    contentKey: 'articles.memoryLossStrategies.content',
    category: 'behaviors',
    readingTimeMinutes: 3,
    order: 21,
  },
  {
    slug: 'managing-aggression',
    emoji: '🛡️',
    titleKey: 'articles.managingAggression.title',
    summaryKey: 'articles.managingAggression.summary',
    contentKey: 'articles.managingAggression.content',
    category: 'behaviors',
    readingTimeMinutes: 4,
    order: 22,
  },
  {
    slug: 'depression-anxiety-apathy',
    emoji: '🌧️',
    titleKey: 'articles.depressionAnxietyApathy.title',
    summaryKey: 'articles.depressionAnxietyApathy.summary',
    contentKey: 'articles.depressionAnxietyApathy.content',
    category: 'behaviors',
    readingTimeMinutes: 4,
    order: 23,
  },
  {
    slug: 'delusions-hallucinations',
    emoji: '👁️',
    titleKey: 'articles.delusionsHallucinations.title',
    summaryKey: 'articles.delusionsHallucinations.summary',
    contentKey: 'articles.delusionsHallucinations.content',
    category: 'behaviors',
    readingTimeMinutes: 3,
    order: 24,
  },
  {
    slug: 'eating-drinking-health',
    emoji: '🥗',
    titleKey: 'articles.eatingDrinkingHealth.title',
    summaryKey: 'articles.eatingDrinkingHealth.summary',
    contentKey: 'articles.eatingDrinkingHealth.content',
    category: 'daily_living',
    readingTimeMinutes: 4,
    order: 25,
  },
  {
    slug: 'toileting-continence',
    emoji: '🚻',
    titleKey: 'articles.toiletingContinence.title',
    summaryKey: 'articles.toiletingContinence.summary',
    contentKey: 'articles.toiletingContinence.content',
    category: 'daily_living',
    readingTimeMinutes: 3,
    order: 26,
  },
  {
    slug: 'enjoyable-day',
    emoji: '☀️',
    titleKey: 'articles.enjoyableDay.title',
    summaryKey: 'articles.enjoyableDay.summary',
    contentKey: 'articles.enjoyableDay.content',
    category: 'daily_living',
    readingTimeMinutes: 3,
    order: 27,
  },
  {
    slug: 'changes-in-judgement',
    emoji: '⚖️',
    titleKey: 'articles.changesInJudgement.title',
    summaryKey: 'articles.changesInJudgement.summary',
    contentKey: 'articles.changesInJudgement.content',
    category: 'safety',
    readingTimeMinutes: 3,
    order: 28,
  },
